...
def train(model, train_loader, val_loader, n_epochs=1, fname="models/resnet50.pth"):
    ...
    # scheduler = MultiStepLR(optimizer, [1, 2, 3, 4])
...
if __name__ == "__main__":
    ...
    model = get_model()
    train(model, train_loader, val_loader, n_epochs=50, fname="models/resnet18-last3-best.pth")
    predict(model, dfpath="data/sample_submission.csv", imgroot="data/test/",
            outpath="data/resnet101-last3-50epochs.csv")
